...
2. Deploying a **data plane** which includes “sidecars”, secondary containers that sit along side of each instance of a microservice and act as a proxy to intercept all incoming and outgoing network traffic. Sidecars are implmented here using [Envoy](https://istio.io/docs/concepts/what-is-istio/overview.html#envoy)
